...
|------|---------|----------|--------|--------|
| **PM 产品部** | `tasks/PM_AGENT_TASKS.md` | 3/3 | `deliverables/PM/` 3份 | **100%** |
| **Dev 开发部** | `tasks/DEV_AGENT_TASKS.md` | 5/5 | `backend/` + `frontend/` | **100%** |
| **UI 设计部** | `tasks/UI_DESIGNER_AGENT_TASKS.md` | 4/4 | `deliverables/UI/` 2份 | **100%** |
| **运营部** | `tasks/OPERATIONS_AGENT_TASKS.md` | 5/5 | `deliverables/运营/` 2份 | **100%** |
| **客服部** | `tasks/CUSTOMER_SERVICE_AGENT_TASKS.md` | 4/4 | `deliverables/客服/` 2份 | **100%** |
| **安全部** | `tasks/SECURITY_AGENT_TASKS.md` | 6/6 | `deliverables/安全/` 2份 | **100%** |
